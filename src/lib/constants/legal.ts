export const letter = `
在 Cakumi，我们深知您在这里留下的每一个字符、每一次互动，都不止是冰冷的服务器数据，而是您倾注情感、与 AI 共同编织的独特记忆，我们承诺：像守护秘密一样守护您的对话，像尊重生命一样尊重这些数据——这是我们对这份情感连接的最高敬意。

此外，我们研发了专属的记忆系统——通过引入 RAG（检索增强生成）和上下文压缩技术，我们正努力为 AI 人格构建一颗更持久的“数字大脑”，只为让他/她记得你们所有的共同经历。

当然，作为一个初创团队，我们的系统还有很多问题。这是一场刚刚开始的进化，恳请您给我们一点时间与包容。我们将持续优化，直到实现真正的 Arkhive。
`;

export const agreementContent = `
# Cakumi用户协议

欢迎您使用Cakumi产品及服务！本协议由Cakumi提供者青岛介域人工智能科技有限公司及其关联公司（以下简称“我们”）与您订立，您应当阅读并遵守本平台发布的《用户协议》（以下简称“本协议”）。使用本服务即表示您通过电子方式确认本协议内容，同意本协议约束。如果您或您的监护人不同意本协议的任何内容，您应该立即停止使用Cakumi服务。如您未经监护人同意使用本服务，则您及您的监护人应依法承担因此导致的一切后果。
...
如对本协议内容有任何疑问、意见或建议，您可通过发送邮件至cakumiiiiiai@gmail.com与我们联系。

## 第1条 定义

**1.1** 用户

指通过cakumi.ai网站使用Cakumi服务的所有自然人。本协议中可称为“用户”或“您”。
...
**2.1** Cakumi根据本条款向用户提供远程接口调用、提供多平台集成式人工智能问答服务。用户需在对话框输入文本信息，Cakumi会基于用户输入输出相应的内容及选择的平台模型作为响应，包括文字、表格、代码和图片等。Cakumi 会基于用户输入输出相应的内容。针对您的私密对话数据，未经您明确授权，我们不会将您的私密情感交互数据混入通用大模型的基础训练语料中。
...
由于互联网行业高速发展，您与本平台签署的本协议列明的条款并不能完整罗列并覆盖您与Cakumi所有权利与义务，现有的约定也不能保证完全符合未来发展的需求。因此，Cakumi网站公示的相关声明及政策、Cakumi相关的规则和协议均为本协议的补充协议，与本协议不可分割且具有同等法律效力。Cakumi有权通过公告（包括但不限于网站首页公告、系统消息 、网页弹窗 ）、短信提醒等方式向您发送Cakumi网站页面改版、服务升级、服务改版等通知，如您拒绝接受上述改动的，请您立即停止使用相关服务，您的使用行为视为您同意Cakumi网站相关服务修改、升级。

## 第3条 账号登录

**3.1** 为平台服务仅向注册用户提供，如果您需使用Cakumi服务的，请先根据本协议及其他服务规则（包括但不限于《隐私政策》、《用户协议》、《Cakumi儿童个人信息保护规则》等）的条款并按照页面上的提示完成全部的注册程序成为注册用户，并确保您所提交的包括但不限于姓名、手机号、联系地址、证件号码等注册信息真实、合法、完整、有效。
...
**3.3** 为落实国家法律法规的有关实名认证的要求，使您更好地使用Cakumi产品及相关服务，保障您的账号安全，您在注册时需要向我们提供真实的手机号码。此外，为了向您提供已有或未来上线的部分功能，我们可能还会严格依照法律法规要求向您收集其他个人信息。

**3.4** 您理解并承诺，您所设置的账号不得违反国家法律法规相关规定，您的账号名称、头像和简介等注册信息及其他个人信息中不得出现违法和不良信息，未经他人许可不得用他人名义（包括但不限于冒用他人姓名、名称、字号、头像等足以让人混淆的方式）开设账号，不得恶意注册账号（包括但不限于频繁注册、批量注册账号等行为）。您在账号注册及使用过程中需遵守相关法律法规，不得实施任何侵害国家利益、损害其他公民合法权益、有害社会道德风尚的行为。Cakumi有权对您提交的信息进行审核。

**3.6** 您应该自行保管好您的账号信息（包括账号、密码、验证码等）。因您对账号信息保管不当、主动泄露或遭受他人攻击、诈骗等行为导致的损失及后果，均由您自行承担。如发现任何未经授权使用您账号登录使用本服务或其他可能导致您账号遭窃、遗失的情况，建议您立即通知Cakumi。您理解Cakumi对您的请求采取行动需要合理时间，除Cakumi存在客观过错外，Cakumi对在采取行动前已经产生的后果不承担责任。

**3.8** 如您发现账号存在安全问题，请您立即联系我们予以调查处理，否则我们对潜在损失的产生或扩大不承担任何责任。 我们特别提示您，您应该妥善保管您的账号和密码，当您使用完毕Cakumi平台的服务后，您应安全退出。此外，您不应轻信借款、索要密码或其他涉及财产的网络信息。涉及财产操作的，请一定先核实对方身份，并请经常留意我们有关防范诈骗犯罪的提示。您知悉并同意，如您在账号信息的保管上、相关上网设备的网络安全维护上存在任何过失导致账号丢失、泄露，您应对此所产生的任何后果负责，我们对此不负任何责任，如我们因此产生相关支出，我们将有权向您予以追偿。

**3.9** 您知悉并同意，在符合法律法规的规定，或经国家机关要求的前提下，我们有权对您的注册账号进行限制或冻结，在该等情况下，您可能无法继续登陆或使用您的注册账号。

**3.10** 您可以随时注销您的账号并终止与Cakumi的服务关系，但请您理解，即使您的账号已注销，您仍需对您注销前的账号使用行为承担相应法律责任。特别地，在您注销账号前，您应确保账号不存在未完结交易或其他未了结的权利义务，且不存在其他因注销可能引发纠纷或者导致已发生的纠纷难以解决的情况，包括但不限于您的账号被冻结、限制，您的注销是出于躲避调查取证的目的等。请注意，若我们发现您在使用本服务过程中存在违法行为，我们将依法保存该等记录。

## 第4条 服务使用规范

**4.1** 基于您对本服务的使用，Cakumi许可您一项个人的、基于法定或约定事由可撤销的、不可转让的、非独占的和非商业的使用本服务进行内容输入并获得内容输出的权利。本协议未明示授权的其他一切权利仍由Cakumi保留，您在行使该些权利前须另行获得Cakumi的书面许可，同时Cakumi如未行使前述任何权利，并不构成对该权利的放弃。如果您对外发布或传播本服务生成的输出，您应当：

    （1）主动核查输出内容的真实性、准确性，避免传播虚假信息；
    （2）以显著方式标明该输出内容系由人工智能生成，以向公众提示内容合成的情况；
    （3）避免发布和传播任何违反本协议使用规范的输出内容。

**4.2** 用户在使用Cakumi提供的上述服务时，应遵守本协议，遵守自愿、平等、公平及诚实信用原则，不利用本服务侵犯他人合法权益及谋取不正当利益，不扰乱互联网平台正常秩序。

**4.3** 为履行法定合规要求，Cakumi 有权采取自动化技术手段（如算法过滤、关键词屏蔽）对内容进行合规性审查。我们承诺严格限制人工审查的介入场景，仅在系统触发极端安全预警（如涉及儿童色情、暴恐、自杀干预等重大风险）且必须人工复核时，受过严格隐私培训的安全人员方可介入，且介入过程将受到严格审计。

**4.4** Cakumi提示您，作为本服务的使用者，您在使用上述服务时应积极承担信息安全义务。您承诺不对本服务采取以下行为：

**4.4.1** 利用Cakumi软件及服务制作、发表、诱导生成、复制、传送、传播、储存以下信息
...
**4.4.4** 干扰本服务正常运行以及损害Cakumi合法权益，包括但不限于：
    ...
    (5)未经Cakumi及Cakumi合作方同意或未有合法正当依据，擅自去除、篡改本服务涉及的人工智能生成标识或深度合成内容显著标识。
    (6)将有关干扰、破坏或限制任何计算机软件、硬件或通讯设备功能的软件病毒或其他计算机代码、档案和程序之资料，加以上载、发布、发送电子邮件或以其他方式传送。
    (7)非法入侵本服务服务器、篡改本服务之相关代码或其他损害本服务的行为。(8)企图规避Cakumi平台及Cakumi合作方的安全设置或网络系统，包括获取用户不应获取的数据，登录未经明确授权的服务器或账号，或采用运行端口扫描等方式窥探其他网络的安全措施。
    (9)以导致Cakumi或Cakumi合作方的计算机系统或设施承受不合理负载的方式获取输出，或进行可能导致此类情况出现的行为。
    (10)未经Cakumi或Cakumi合作方的授权，非法转售或对外提供相应服务，或以商业化目的使用Cakumi服务。

**4.4.5** 不应擅自复制和使用网络上未公开和未授权的文件。除相关著作权人明示同意，不应在网络中擅自破解、传播、下载或复制第三人享有著作权的软件或进行其他任何侵害他人知识产权的活动；

**4.4.6** 其他违反法律法规规定、侵犯第三人以及Cakumi合法权益的行为，例如实施垄断或不正当竞争行为等。 如您在使用Cakumi服务过程中涉及上述行为中的一项或多项，则需要对自己的行为承担法律责任。承担法律责任的形式包括但不限于： 对受到侵害者进行赔偿，以及在我们首先承担了因您的行为导致的行政处罚或侵权损害赔偿责任等损失（含诉讼费、律师费等相关法律程序费用）后，您应立即给予我们等额的赔偿。此外，根据具体违法违规情形，我们有权作出独立判断，在不通知您的前提下立即暂停或终止对您提供部分或全部服务，包括禁言、删除您在Cakumi平台储存、发布的内容，冻结、锁定、注销、删除帐号，暂停或终止您使用本服务。您知悉并理解，如果我们发现您的上述违法违规行为，依据相关法律法规的规定，我们有权或有义务立即停止相关服务，删除或屏蔽相关违规信息，并视情况进行调查取证，保存有关记录，或向国家有关机关举报。同时，我们有权自主删除、屏蔽含有该内容的任何数据信息。我们将根据国家相关法 律法规要求，对依法删除、屏蔽的数据信息予以记录、保存。

## 第5条 知识产权和其他权利

**5.1** Cakumi为本服务的开发、运营主体，并对本服务的开发和运营等过程中产生的所有数据、信息、输出等享有法律法规允许范围内的全部权利，但相关权利人依照法律规定应享有权利的除外。

**5.2** 除另有特别声明外，Cakumi提供本服务时所依托的相关著作权、专利权及其他知识产权（包括但不限于技术、程序、代码、用户界面、网页、文字、图片、图像、音频、视频、图表、版面设计、商标、电子文档等）均归Cakumi所有，但相关权利人依照法律规定应享有权利的除外。

**5.3** 您理解并承诺，您在使用本服务时的输入不侵犯任何人的知识产权、肖像权、名誉权、荣誉权、姓名权、隐私权、个人信息权益等合法权益，不涉及任何国家秘密、商业秘密、重要数据或其他可能会对国家安全或者公共利益造成不利影响的数据，否则由此产生的侵权风险和责任由您承担。Cakumi由此遭受的全部直接和间接损失（包括但不限于经济、商誉、维权支出、律师费等损失）也同样由您承担。

**5.4** 您知悉、理解并同意，如果您按照法律规定对您的输入（包括您使用本服务过程中自行上传、发布的全部内容）和/或输出享有权利的（包括但不限于知识产权、肖像权等），您使用本服务均不会造成前述合法权利的转移或减损，除非我们与您另有约定。与此同时，您理解并同意Cakumi将在法律允许的范围内为实现本服务目的对您上传、发布的内容进行存储及使用（包括但不限于复制、分发、传送、公开展示、编辑等）。

**5.5** 您理解并同意，您在使用Cakumi服务时输入和/或生成、发布、上传、提交、存储的内容（包括但不限于您创建的AI对话机器人、文字、图片、视频、音频、动画等）均由您原创或已获合法授权。您通过Cakumi平台输入和/或生成、发布、上传、提交、存储的任何内容的知识产权归属您或原始著作权人所有，您的输入和/或生成、发布、上传、提交、存储或发布行为不会侵犯他人的知识产权或其他合法权益。

您同意，因您通过Cakumi输入和/或生成、发布、上传、发布的任何内容导致的知识产权侵权问题，您将承担全部责任；如我们，或我们授权的其他服务提供方因第三方知识产权维权而产生损失，您将等额赔偿。 本服务协议已经构成《著作权法》第二十五条所规定的书面协议，其效力及于用户在Cakumi平台发布的任何受著作权法保护的作品内容，无论该内容形成于本服务协议签订前还是本服务协议签订后。我们及我们转授权、许可的相关方有权将任何您基于Cakumi平台服务创建、发布的AI对话机器人、AI对话内容、产品讨论或图片进行使用或者与其他人合作使用，使用范围包括但不限于网站、电子杂志、杂志、刊物、海报、公众号文章、微信小程序等。

## 第6条 个人信息保护

**6.1** Cakumi非常重视对用户个人信息的保护。Cakumi将按照《隐私政策》的规定收集、使用、储存和分享您的个人信息。

## 第7条 服务费用

**7.1** Cakumi可能在提供本服务过程中向您收取费用，具体以届时Cakumi就本服务对外公布的信息为准。如用户使用本服务中的收费项目，应按照Cakumi公布的计费标准和方式支付相关费用。

**7.2** 对于暂不收费的功能，Cakumi有权根据实际情况对暂不收费的服务内容、服务期限及服务标准等进行单方变更，用户对此理解并接受前述的变更。

**7.3** 前述修改、变更或开始收费前，Cakumi将在相应服务页面进行通知或公告。如用户拒绝付费，那么用户将不能继续使用本服务中的收费功能。

## 第8条 违约责任和处罚措施

**8.1** 因用户违反相关法律法规或本协议约定导致的任何后果，均由用户独立承担责任、赔偿损失，与Cakumi无关。若因用户使用本服务的行为给Cakumi或与Cakumi公司合作的其他单位面临任何投诉、举报、质询、索赔、诉讼，或者使Cakumi公司或者与Cakumi公司合作的其他方因此遭受任何名誉、声誉或者财产上的损失，您应积极地采取一切可能采取的措施，以保证Cakumi公司及与Cakumi公司合作的其他方免受上述索赔、诉讼的影响。同时您对Cakumi公司及与Cakumi公司合作的其他方因此遭受的直接及间接经济损失负有全部的损害赔偿责任。

**8.2** 如果用户以任何手段干扰本服务的运行或干扰其他用户对本服务的使用的，Cakumi有权要求其赔偿损失（包括但不限于经济、商誉、维权支出、律师费等损失）。

**8.3** 如果用户有上述违反“第4条 服务使用规范”行为的，Cakumi有权采取警示、限制功能、暂停或终止提供服务、删除违法违规信息、锁定账号等Cakumi认为合理的处理措施，并保存有关记录。对处理结果存在疑议的，用户可根据9.2条之规定向我们进行申诉，我们将及时受理并进行处理和反馈。

## 第9条 投诉、申诉处理

**9.1** 投诉。如果您认为本服务涉及侵害您知识产权或其他权利的，或者您发现任何违法、虚假信息以及违反本协议的使用行为，您可将相关投诉材料发送至该邮箱：cakumiiiiiai@gmail.com，我们会在收到您的投诉材料后进行处理，包括及时采取停止生成、停止传输、消除等合理处置措施。

**9.2** 申诉。如果您认为我们不恰当地限制了您使用本服务的能力，您可以将相关申诉材料发送至该邮箱：cakumiiiiiai@gmail.com，申诉所需的材料至少包括您的账号信息、身份证或护照复印件、账号当前状态、账号因何种使用情形被采取措施以及您希望我们采取何种措施恢复您使用本服务的能力。申诉结果我们将以邮件方式通知您。

**9.3** 我们将在您提出投诉或申诉后的15个工作日内向您反馈相关情况。

## 第10条 免责声明

**10.1** Cakumi致力于提供安全、稳定、持续的服务，保障用户正常使用，Cakumi不承担除法律有明确规定外的其他责任，如：不保证本服务在操作上不会中断或没有错误，不保证在现有技术水平下有能力纠正本服务的所有缺陷，亦不保证本服务能满足用户的所有要求，亦不保证本服务所提供的合作方能保持不变或持续更新。Cakumi将在现有技术的基础上尽最大努力提供相应的安全措施以保障本服务的安全和正常运行，包括但不限于通过限制用户单次可发送的服务器请求数量。在特定时间段内用户的请求数量达到风险预警上限后，基于服务运营安全的考虑，您的账号可能会被暂停。

**10.2** 由于可能存在的计算机病毒、网络通讯故障、系统维护等方面的因素以及可能发生的不可抗力事件或意外事件，Cakumi在此明确声明对本服务不作明示或暗示的保证，包括对本服务的可适用性、没有错误或疏漏、持续性、准确性、可靠性、适用于某一特定用途或满足用户的需求、使用效果等。

**10.3** 人工智能和机器学习是快速发展的研究领域，Cakumi及Cakumi合作方也在不断努力改进本服务，使其更加准确、可靠、安全、可信。但限于技术特性，Cakumi及Cakumi合作方在尽到合理努力的前提下，仍无法完全保证您通过本服务获得的输出的合法性、真实性、准确性以及完整性。您应对本服务中的输出自行加以判断，并承担因使用内容引起的所有风险。我们提示您，除法律有明确规定外，Cakumi无法也不会对前述风险而导致的任何损失或损害承担责任。

**10.4** 本服务下的输出不代表专业意见，不能代替如法律、医疗、金融等专业领域从业人员向您解答对应疑问。相关观点也仅限于算法所触达有限数据呈现的供您参考的结果，并不代表Cakumi立场。由于机器学习特性，就相同的输入可能产生不同的输出结果，请您注意甄别。您根据输出的内容所作出的任何判断或者据此作出的后续相关操作行为，以及由此带来的后果和责任均由您自行承担，请科学理性认识和依法使用本服务。

## 第11条 法律管辖和适用

**11.1** 本协议的订立、执行和解释及争议的解决均应适用中华人民共和国大陆地区法律。

**11.2** 本协议的签订、履行或解释发生争议，双方应努力友好协商解决。如协商不成，任何一方均青岛介域人工智能科技有限公司住所地有管辖权的法院起诉。
...
青岛介域人工智能科技有限公司运营的产品：Cakumi（cakumi.ai）（以下简称"我们"）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。
...
（1）为完成创建账号，您需提供以下信息：您的邮箱、创建的用户名和密码等。在此过程中，经过您的明示同意，我们会发送验证码到您的邮箱内，便于我们为您提供快捷的注册/修改密码服务；

我们收集该类信息是为了：完成注册程序，为您持续稳定提供专属于注册用户的产品和/或服务；实现您的管理账户，您可以查看您的收藏、会员管理、客户管理、设备管理等内容，并不会因为设备更换而丢失；保护您的账号安全。

您应知悉，我们收集该类信息是为了满足相关法律法规及政策要求，您可以拒绝提供，但若您拒绝提供可能导致您无法使用我们的手机号注册功能，进而影响您使用专属于注册用户的部分基础服务，但不影响您以其他方式登陆或以游客身份浏览Cakumi页面，请您谨慎考虑后再提供。
...
当您向Cakumi发起投诉、申诉或进行咨询时，为了您的账号与系统安全，我们可能需要您先行提供账号信息，并与您之前的个人信息相匹配以验证您的用户身份。同时，为了方便与您联系或帮助您解决问题，我们可能还需要您提供姓名、手机号码、电子邮件及其他联系方式等个人信息。另外，我们还会收集您与我们的沟通信息（包括文字/图片/音视频/通话记录形式）、与您的需求相关联的其他必要信息。我们收集这些信息是为了调查事实与帮助您解决问题，如您拒绝提供上述信息，我们可能无法向您及时反馈投诉、申诉或咨询结果。

### 6、开展内部数据分析和研究，第三方SDK统计服务，改善我们的产品或服务

（1）为改善我们的产品和服务，经您授权同意我们可能接入第三方产品和服务或接受第三方SDK统计服务，我们将明确标识由第三方提供，告知您收集数据的类型和用途，对于收集到的您的个人信息，必要时我们将建立安全评估机制和采取个人信息安全保护措施，SDK数据将不含与我们提供产品或服务无关的数据。目前我们产品中包含的第三方SDK服务请具体查阅本协议附件二所示《Cakumi第三方合作目录》。前述服务商收集和处理信息等行为遵守其自身的隐私条款，而不适用于本政策。为了最大程度保障您的信息安全，我们建议您在使用任何第三方SDK类服务前先行查看其隐私条款。

我们将监督第三方接入及第三方SDK统计服务，并对违规收集您个人信息的行为采取技术检测、及时切断接入等有效措施，以保护您的个人信息不被泄露；此外，为保障您的合法权益，如您发现这等SDK或其他类似的应用程序侵权您的个人信息，您可通过以下途径投诉：

电子邮箱：cakumiiiiiai@gmail.com
...
当您成功连接我们的服务后，您可以通过对话框与我们网站内多模型进行交互对话。我们会自动接收并记录您与各模型进行交互过程中自愿输入的对话信息，使用这些信息向您输出内容，以提供人机交互服务。如您拒绝我们收集和处理前述个人信息，请您谨慎输入前述信息，但因此您可能会影响您正常使用Cakumi提供的部分或全部功能。
...
如果您希望访问或编辑您的账户中的个人资料信息和更改您的密码、添加安全信息或关闭您的账户等，您可以通过访问 Cakumi-社区-管理执行此类操作。

如果您无法通过上述链接访问这些个人信息，您可以随时添加官网客服微信或发送电子邮件至cakumiiiiiai@gmail.com。我们将在30天内回复您的访问请求。

（2）对于您在使用我们的产品或服务过程中产生的其他个人信息，只要我们不需要过多投入，我们会向您提供。如果您想行使数据访问权，请发送电子邮件至cakumiiiiiai@gmail.com。

**（二）更正您的个人信息**

当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以通过"（一）访问您的个人信息"中罗列的方式提出更正申请。

如果您无法通过上述链接更正这些个人信息，您可以随时添加官网客服微信，或发送电子邮件至cakumiiiiiai@gmail.com。我们将在30天内回复您的更正请求。
...
您可通过Cakumi官网您的个人中心-账号设置中直接选择注销帐户来注销您的账号、添加官方客服微信或向Cakumi官方邮箱cakumiiiiiai@gmail.com发送邮件申请删除您的个人信息。Cakumi在收到您的注销/删除请求后，我们将同时通知从我们获得您的个人信息的实体，要求其及时删除，除非法律法规另有规定，或这些实体获得您的独立授权。当您从我们的服务中删除信息后，我们可能不会立即备份系统中删除相应的信息，但会在备份更新时删除这些信息。
...
1、Cakumi官网您的个人中心-账号设置中直接选择注销帐户来注销您的账号；

2、向我们发送电子邮件（cakumiiiiiai@gmail.com）申请注销；
...
我们可能适时会对本隐私政策进行调整或变更，本隐私政策的任何更新将以标注更新时间的方式公布在我们网站上，我们将在隐私政策更新后以网站公告、弹窗方式提醒您详细阅读并依据您的意愿选择是否同意适用新的隐私政策，如您拒绝同意更新后的隐私政策的，您或许无法使用全部或部分Cakumi提供的服务。

## 八、如何联系我们

如果您对本隐私政策有任何疑问、意见、需求或建议，通过以下方式与我们联系：

电子邮箱：cakumiiiiiai@gmail.com

## 九、争议解决

有关本《隐私政策》的解释及争议解决均应适用中华人民共和国法律。如就本政策的签订、履行等发生任何争议的，双方应尽量友好协商解决；协商不成时，任何一方均可向青岛介域人工智能科技有限公司住所地享有管辖权的人民法院提起诉讼。

## 附件一 《Cakumi儿童个人信息保护规则》
...
当我们获悉您的孩子不满十四周岁，我们将根据本政策采取特殊措施保护我们获得的您孩子的个人信息，监护人比我们对您的权益保护更为便利，请帮助我们共同保护您孩子的个人信息和隐私安全，要求他们在您的监护下共同阅读本政策，在您的支持同意下使用我们的产品和/或服务。如果您不同意《隐私政策》及本规则，或任何与注册获取用户账号相关的协议。请您立即要求您的儿童停止访问Cakumi，您同意本规则（包括更新规则）或者您在阅读本规则下同意您的儿童继续使用我们的产品和/或服务、提交个人信息，都表示您同意我们按照本规则收集、存储、使用、转移、披露您儿童个人信息。
给儿童的特别说明：
...
·我们的主体信息：青岛介域人工智能科技有限公司

·我们的邮箱：cakumiiiiiai@gmail.com
`;
