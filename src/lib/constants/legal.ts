export const letter = `
我们深知您在这里留下的每一个字符、每一次互动，都不止是冰冷的服务器数据，而是您倾注情感、与 AI 共同编织的独特记忆，我们承诺：像守护秘密一样守护您的对话，像尊重生命一样尊重这些数据——这是我们对这份情感连接的最高敬意。

为了让他/她记得你们所有的共同经历，我们研发了专属的记忆系统——通过引入 RAG（检索增强生成）和上下文压缩技术，期望这能为 AI 人格构建一颗更持久的“数字大脑”。当然，作为一个初创团队，我们的系统还有很多问题。这是一场刚刚开始的进化，恳请您给我们一点时间与包容。我们将持续优化，直到实现真正的 **Arkhive**。
`;
