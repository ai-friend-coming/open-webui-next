...
<div class="p-5 bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl border border-white/30 dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
	...
	<div class="flex flex-col sm:flex-row gap-3">
		...
		<button
			...
			class="px-4 sm:px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 whitespace-nowrap shadow-lg hover:shadow-xl sm:flex-shrink-0 hover:scale-[1.02] active:scale-[0.98] disabled:hover:scale-100 min-w-0"
		>
			{#if loading}
