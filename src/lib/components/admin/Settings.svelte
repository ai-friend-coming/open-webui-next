<script>
	...
	import Invite from './Settings/Invite.svelte';
	import RechargeTiers from './Settings/RechargeTiers.svelte';
...
<div class="sensitive flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	<div
	...
	>
		...
		<button
			...
			'redeem-codes'
				...
				: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
			on:click={() => {
				goto('/admin/settings/redeem-codes');
			}}
		>
			<div class=" self-center mr-2">
				<svg
		...
		<button
			id="first-recharge-bonus"
			class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
			'first-recharge-bonus'
				? ''
				: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
			on:click={() => {
				goto('/admin/settings/first-recharge-bonus');
			}}
		>
			<div class=" self-center mr-2">
				<svg
			...
			<div class=" self-center">首充优惠</div>
		</button>
		...
		>
			...
			<div class=" self-center">邀请配置</div>
		</button>
		...
		<button
			...
			'recharge-tiers'
				...
				: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
			on:click={() => {
				goto('/admin/settings/recharge-tiers');
			}}
		>
			<div class=" self-center mr-2">
				<svg
			...
			<div class=" self-center">充值档位</div>
		</button>
	...
	>
		...
		{:else if selectedTab === 'invite'}
			<Invite />
		{:else if selectedTab === 'recharge-tiers'}
			<RechargeTiers />
		{/if}
	</div>
</div>
