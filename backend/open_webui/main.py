...
app.state.config.GLOBAL_API_INPUT_PRICE = GLOBAL_API_INPUT_PRICE
app.state.config.GLOBAL_API_OUTPUT_PRICE = GLOBAL_API_OUTPUT_PRICE
...
app.include_router(images_caption.router, prefix="/api/v1/images/caption", tags=["images_caption"])
    ...
    return {
        **({"onboarding": True} if onboarding else {}),
            ...
            "features": {
                ...
                "enable_sms_verification": ENABLE_SMS_VERIFICATION,
