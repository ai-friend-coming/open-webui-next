...
async def generate_image_prompt(
    ...
    log.debug(
        f"generating image prompt using model {task_model_id} for user {user.email or user.phone or user.id} "
    )
...
async def generate_queries(
    ...
    log.debug(
        f"generating {type} queries using model {task_model_id} for user {user.email or user.phone or user.id}"
    )
...
async def generate_autocompletion(
    ...
    log.debug(
        f"generating autocompletion using model {task_model_id} for user {user.email or user.phone or user.id}"
    )
...
async def generate_emoji(
    ...
    log.debug(f"generating emoji using model {task_model_id} for user {user.email or user.phone or user.id} ")
